...
public class CharCheckUtil {
	...
	public static boolean isPhoneNum(String phonenum) {
		boolean matches = phonenum.matches("^[1][3578][0-9]{9}$");

		return matches;

		/*Pattern pattern = Pattern.compile("((\\\\(\\\\d{2,3}\\\\))|(\\\\d{3}\\\\-))?(1[34578]\\\\d{9})");
//		Pattern pattern = Pattern.compile("^[1][358][0-9]{9}$");
	 ...
	 * @param str
	 */
	public static String inciseString(String str) {
		
		String stage=str.substring(0,3);
		return stage;
	}
