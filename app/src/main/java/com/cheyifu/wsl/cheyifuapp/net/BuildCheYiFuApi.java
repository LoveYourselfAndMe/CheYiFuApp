...
import com.cheyifu.wsl.cheyifuapp.net.interceptor.LogInterceptor;
import com.cheyifu.wsl.cheyifuapp.net.interceptor.NetCacheInterceptor;
import com.cheyifu.wsl.cheyifuapp.utils.Logger;
 ...
 */
public class BuildCheYiFuApi {
    private static final String TAG = BuildCheYiFuApi.class.getSimpleName();
    //    public final static String URL_BASE_DEBUG = "http://192.168.0.197:8080/petconsole/"; // API接口调用的公共网址
    public final static String URL_BASE_RELEASE = "http://192.168.1.6:8889/app/"; // API接口调用的公共网址
